      ...
      <div className="xl:mx-12 md:mx-10 mx-3 my-8 py-8">
        ...
        <div className="antialiased bg-white text-gray-800">
          <div className="relative container mx-auto px-6 flex flex-col">
            <div className="absolute z-0 w-2 h-full rounded-lg bg-[#F9E1CF] shadow-md inset-0 left-17 md:mx-auto md:right-0 md:left-0">
              {" "}
            </div>{" "}
            {TimelineData.map((timeline, id) => (
              <div key={id} className="relative z-10">
                ...
                >
                  <div className="bg-[#F9E1CF] mb-3 xl:mt-0 md:mt-0 mt-0 border-b-1 xl:p-10 md:p-8 p-5 rounded-3xl shadow-lg xl:ml-0 md:ml-0 ml-12">
