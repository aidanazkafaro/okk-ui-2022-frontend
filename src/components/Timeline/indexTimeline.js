          ...
          <div className="relative container mx-auto px-6 flex flex-col">
            ...
            {TimelineData.map((timeline, id) => (
              <div key={id} className="relative z-10">
                <div className="h-16 w-16 object-cover mt-20 bg-[#E1AA43] rounded-full shadow-md border-4 border-[#F9E1CF] xs:absolute md:mx-auto md:left-0 md:right-0" />
                <div
                  className={`${
                    id % 2 === 0
                ...
                >
                  ...
                  <div className={`"mb-3 hover:text-white xl:mt-0 md:mt-0 mt-0 border-b-1 xl:p-10 md:p-8 p-5 rounded-3xl shadow-lg xl:ml-0 md:ml-0 ml-12" ${id % 2 === 0 ? "hover:bg-[#9F6D55] bg-[#E1AA43]":"hover:bg-[#9F6D55] bg-[#F9E1CF]"}`}>
