...
import { TimelineData, TimelineDataAgustus, TimelineDataJuli } from "./TimelineData";
    ...
    <>
      ...
      <div className="xl:mx-12 md:mx-10 mx-3 py-8">
        ...
        <div className="mx-auto w-1/2 md:w-1/4 mb-14 flex">
          <h1 className={`${july ? "text-orange-400 border-orange-400" : ""} text-lg font-bold text-center w-1/2 cursor-pointer border-2 `} onClick={()=>{
            setJuly(true);
