...
const CariKelompok = () => {
  ...
  return (
    <div className="main-sect">
      <h2 className="text-3xl font-semibold font-signika title-2 text-white">
        {" "}
        Cari berdasarkan:{" "}
      </h2>
      <div className="input">
        <div className="my-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <label
                for="npm"
                className="cursor-pointer label text-white text-3xl font-signika"
              >
                {" "}
                NPM{" "}
              </label>
          ...
          >
            <input
              ...
              value={valNpm}
              onChange={(e) =>
                setValNpm((v) => (e.target.validity.valid ? e.target.value : v))
              }
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex flex-col">
              <label
                for="line"
                className="cursor-pointer label2 text-white text-3xl font-signika"
              >
                {" "}
                ID LINE{" "}
              </label>
