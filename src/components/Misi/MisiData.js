...
export const misiItems = [
  {
    ...
    deskripsi:
      "Selamat datang, Agnibrata Makara! Dalam memulai perjalanan yang panjang, mari tumbuhkan rasa bangga terhadap dirimu terlebih dahulu sebagai salah satu dari ribuan orang yang berhasil menjadi bagian dari kampus perjuangan. Melalui misi ini, kamu dapat membagikan rasa bangga serta rencana dan harapan dalam membuka lembaran baru di Universitas Indonesia.",
