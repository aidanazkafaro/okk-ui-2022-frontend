      ...
      <div className="bg-[#E1AA43]">
        <div className="flex justify-between  mx-auto max-w-[1400px] py-10 px-5 sm:px-10 md:px-10 lg:px-24 2xl:px-32 3xl:px-0 ">
          <div>
            ...
            <p className="text-sm">Farah | 085716182634</p>
            <p className="text-sm">Shafmed | 087770558657</p>
            <p className="text-sm">Yud | 085959563107</p>
          ...
          <div className="flex gap-3 items-end">
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.instagram.com/okk_ui/"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://liff.line.me/1645278921-kWRPP32q?accountId=okkui&amp;openerPlatform=native&amp;openerKey=home%3Arecommend#mst_challenge=m-gye6CtYl1DdKZEzBpBovW-k5y_HQRuZsYKXNCeFOU"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.youtube.com/channel/UCKHfpWWWmXznpsiTswayd0g"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.facebook.com/OKK-UI-1667380366904251/"
            >
