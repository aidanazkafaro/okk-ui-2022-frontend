...
const IndexAbout = () => {
  return (
    ...
    <h2 className="about-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
      ...
      Sit porta quis arcu amet sed erat arcu et. 
      Sit facilisi at ac cursus pulvinar interdum purus pharetra. 
      Odio vel suspendisse tempus eu eget cras viverra augue. 
      Purus suspendisse eu eget viverra sit. Egestas diam quis nunc, adipiscing nisl. 
      Id leo sodales scelerisque vitae cras. 
      Mi porttitor turpis tellus tempus donec ut donec consectetur ipsum. 
